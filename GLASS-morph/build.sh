...
GLASS="$ROOT/GLASS"
CPM="$ROOT/.cpm-cache"
CTRU_INC="$CPM/libctru/8a80/libctru/include"          # CPM-fetched fork libctru headers
...
arm-none-eabi-gcc main.c build/vshader_shbin.o -o GLASS-morph.elf \
...
3dsxtool GLASS-morph.elf GLASS-morph.3dsx

echo "Done -> GLASS-morph.3dsx"
